...
GONDUL_ARCH_ := $(TARGET_ARCH)
endif

ifeq ($(strip $(GONDUL_ARCH_)),x86_64)
...
ifeq ($(strip $(GONDUL_ARCH_)),arm64)

$(warning  "GPU: include $(LOCAL_PATH)/gondul_arm64.mk")
include  $(LOCAL_PATH)/gondul_arm64.mk
...
LOCAL_SRC_FILES :=  usr/gralloc.gondul.so
endif
