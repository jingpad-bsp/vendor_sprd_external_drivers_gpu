...
#Symlink Vulkan
LOCAL_POST_INSTALL_CMD = $(hide)\
	if [ ! -d  $(dir $(LOCAL_INSTALLED_MODULE))/../hw ];then echo "hw do not exist" \
	; mkdir -p $(dir $(LOCAL_INSTALLED_MODULE))/../hw; else echo "hw do exist"; fi \
...
ifeq ($(strip $(BUILD_BOTH_32_AND_64)), true)
  ...
  LOCAL_MULTILIB := both
  LOCAL_SRC_FILES_32 :=  usr/$(MALI_PLATFORM_NAME)/gralloc.gondul.so
  LOCAL_SRC_FILES_64 :=  usr/$(MALI_PLATFORM_NAME)/gralloc.gondul_64.so
